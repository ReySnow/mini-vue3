...
const CREAETE_ELEMENT_BLOCK = Symbol('createElementBlock');
const helperMapNames = {
    [TO_DISPLAY_STRING]: 'toDisplayString',
    [CREAETE_ELEMENT_BLOCK]: 'createElementBlock'
};
...
export { createApp, createVNode as createElementBlock, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, nextTick, provide, proxyRefs, ref, registerRuntimeCompiler, renderSlots, toDisplayString };
