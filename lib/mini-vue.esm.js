...
function createRenderer(options) {
    ...
    // n1老的 n2新的
    function patch(n1, n2, container, parentCompontent) {
    ...
    function processFragment(n1, n2, container, parentCompontent) {
    ...
    // 处理类型为element的vnode
    function processElement(n1, n2, container, parentCompontent) {
        if (!n1) {
    ...
    // 处理子节点
    function mountChildren(n2, container, parentCompontent) {
    ...
    function processComponent(n1, n2, container, parentCompontent) {
