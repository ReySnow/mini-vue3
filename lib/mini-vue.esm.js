...
function createRenderer(options) {
    ...
    function patch(vnode, container, parentCompontent) {
    ...
    function processFragment(vnode, container, parentCompontent) {
    ...
    // 处理类型为element的vnode
    function processElement(vnode, container, parentCompontent) {
        mountElement(vnode, container, parentCompontent);
    }
    // 挂载elememt
    function mountElement(vnode, container, parentCompontent) {
    ...
    // 处理子节点
    function mountChildren(vnode, container, parentCompontent) {
    ...
    function processComponent(vnode, container, parentCompontent) {
        mountComponent(vnode, container, parentCompontent);
    }
    // 挂载component
    function mountComponent(initialVNode, container, parentCompontent) {
        // 创建组件实例
